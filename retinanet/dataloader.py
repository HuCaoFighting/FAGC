...
class CSVDataset_event(Dataset):
    ...
    def __init__(self, dataset_name, train_file, class_list, root_event_dir, root_img_dir, transform=None):
        """
        Args:
    ...
    def load_image(self, image_index):
        ...
        if self.dataset_name == 'dsec':
            ...
            file = self.image_names[image_index]
            img_file = os.path.join(self.img_dir,file.replace('.npz','.png'))
    ...
    def image_aspect_ratio(self, image_index):
        ...
        file = self.image_names[image_index].split('/')
        img_file = os.path.join(self.img_dir,file[-3],'images/left/rectified',file[-1].replace('.npz','.png'))
        image_rgb = Image.open(img_file)
        return float(image_rgb.width) / float(image_rgb.height)
...
class Normalizer(object):
    ...
    def __init__(self, dataset_name='dsec'):
        ...
        elif dataset_name == 'ddd17':
            self.mean, self.std = [[[0.403, 0.403, 0.403]]], [[[0.295, 0.295, 0.295]]]
