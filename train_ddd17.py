...
def main(args=None):
    ...
    parser.add_argument('--csv_train', default=f'/media/data/hucao/zhenwu/hucao/PKU-DDD17_all/annotations_CSV/labels_filtered_train.csv',
                        help='Path to file containing training annotations (see readme)') 
    parser.add_argument('--csv_classes', default=f'/media/data/hucao/zhenwu/hucao/PKU-DDD17_all/annotations_CSV/labels_filtered_map.csv', 
                        help='Path to file containing class list (see readme)')
    parser.add_argument('--csv_val', help='Path to file containing validation annotations (optional, see readme)') 
    parser.add_argument('--root_img',default=f'{base_dir}/images/train/aps_images',help='dir to root rgb images') 
    parser.add_argument('--root_event', default=f'{base_dir}/images/train/dvs_events',help='dir to toot event files in dsec directory structure')
    ...
    dataloader_train = DataLoader(dataset_train, batch_size=4, num_workers=6, shuffle=True,collate_fn=collater)
    dataset_val1 = CSVDataset_event(dataset_name=parser.dataset_name, train_file='/media/data/hucao/zhenwu/hucao/PKU-DDD17_all/annotations_CSV/labels_filtered_test_all.csv', class_list=parser.csv_classes,
